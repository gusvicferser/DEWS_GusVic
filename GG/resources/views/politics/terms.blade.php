...
@section('content')
    <div class="container-fluid d-flex m-auto align-items-center justify-content-center">
        ...
        <p>El presente aviso legal regula el uso del sitio web <a href="{{ route('index') }}">https://www.gg.game</a> (en
            adelante, "el Sitio Web"), cuyo titular es <span>Ganking Gods S.L. </span> (en adelante, "el Titular"), con
            domicilio en C/ Jungla num 6, piso 9 y NIF/CIF 666999666FWD.</p>
        <p>Contacto: gg.contact@gankingods.game | Teléfono: 111222333</p>
        ...
        <p>Todos los contenidos del Sitio Web son propiedad del Titular o de terceros. No se ceden derechos de explotación.
        </p>
        ...
        <p>Consulta nuestra <a href="{{ route('privacy') }}">Política de Privacidad</a> para más información sobre el
